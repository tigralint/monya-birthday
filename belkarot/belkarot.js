document.addEventListener('DOMContentLoaded', () => {
    ...
    function requestQuarantineCode() {
        ...
        if (code === null) {
            ...
            // Ничего не делаем, оставляем страницу "глючить" вечно.
            // Можно добавить сообщение в консоль для себя
            console.warn("Протокол карантина отменен пользователем. Система оставлена в нестабильном состоянии.");
            document.getElementById('main-glitch-header').dataset.text = "КАРАНТИН ОТКЛОНЕН. СИГНАЛ ПОТЕРЯН.";
